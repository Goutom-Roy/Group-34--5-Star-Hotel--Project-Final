 ...
 * @author ASUS
 */
public class MonthlyProfitBarChartController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        series.getData().add(new XYChart.Data<String,Number>("Accommodation",25));
        series.getData().add(new XYChart.Data<String,Number>("Food and Bevarage",300));
        series.getData().add(new XYChart.Data<String,Number>("Meetings and Events",160));
        series.getData().add(new XYChart.Data<String,Number>("Recreational Facilities",270));
        //series.getData().add(new XYChart.Data<String,Number>("Spa and Wellness",200));
         series.getData().add(new XYChart.Data<String,Number>("Room Upgrades and Add-on",250));
