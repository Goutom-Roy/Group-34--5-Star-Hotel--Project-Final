 ...
 * @author ASUS
 */
public class OverallAnalysisController implements Initializable {
    ...
    @FXML
    private void restaurantPerformanceAnalysis(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("RestaurantPerformanceAnalysisScene.fxml"));
        Parent parent = loader.load();
