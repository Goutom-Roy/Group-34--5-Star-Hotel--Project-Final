 ...
 * @author gouto
 */
public class CEO_Finance24SceneController implements Initializable {
    ...
    private void labelMouseEnterOnClick(MouseEvent event) {
        statusLabel.setText(" Financial performance 2024 ");
    }
    ...
    private void loadPieChartButtonOnAction(ActionEvent event) {
        ...
        list.add( new PieChart.Data("Pretty much",50) );
        list.add( new PieChart.Data("Moderat",25) );
