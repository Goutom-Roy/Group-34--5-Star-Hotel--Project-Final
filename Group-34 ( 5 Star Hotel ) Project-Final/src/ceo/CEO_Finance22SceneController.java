 ...
 * @author gouto
 */
public class CEO_Finance22SceneController implements Initializable {
    ...
    private void labelMouseEnterOnClick(MouseEvent event) {
        statusLabel.setText("Financial performance 2022 ");
    }
    ...
    private void loadPieChartButtonOnAction(ActionEvent event) {
        ...
        list.add( new PieChart.Data("Pretty much",37.50) );
        list.add( new PieChart.Data("Moderat",37.50) );
