...
public class RevenueManagerHelpCenterController implements Initializable {
    ...
    private void OnclickDashboardbutton(ActionEvent event) throws IOException {
        ...
        Parent root = null;
           ...
           if(event.getSource()== Dashboardbuttonfxid) {
            ...
            root = FXMLLoader.load(getClass().getResource("RevenueManagerDashboard.fxml"));
        ...
        stage.setTitle("RevenueManagerDashboard");
        stage.show(); 
